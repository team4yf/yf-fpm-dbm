module.exports = {
    ...
    CONNECTION_IS_NULL:    {errno:-1006,   code:'CONNECTION__IS_NULL', message:"connection is null!"},
    DATA_TYPE_ERROR:       {errno:-1007,   code:'DATA_TYPE_ERROR',     message:"Data Should be Object Or Array!"},

    COMMAND_SQL_ERROR:     {errno:-1008,   code:'COMMAND_SQL_ERROR',   message:"Command Sql Should be String Or Array Of String!"},
};
